...
<tags:pageTemplate titulo="Livros de Java, Android, IOS e muitos mais...">
		...
		<div class="container">
			...
			<section class="data product-detail">
				...
				<p>Data de publicação: 
					<span class="publishedAt"> <fmt:formatDate pattern="dd/MM/yyyy" value="${produto.dataLancamento.time }"/>
					</span>
				</p>
				<p>
